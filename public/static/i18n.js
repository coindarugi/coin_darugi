...
const translations = {
  ko: {
    ...
    aiForecastClickMsg: '클릭하면 8개 주요 코인의 AI 분석을 확인할 수 있습니다 (API 호출)',
  ...
  en: {
    ...
    aiForecastClickMsg: 'Click to see AI analysis of 8 major coins (API call)',
  ...
  fr: {
    ...
    aiForecastClickMsg: 'Cliquez pour voir l\'analyse IA de 8 pièces majeures (appel API)',
  ...
  de: {
    ...
    aiForecastClickMsg: 'Klicken Sie, um die KI-Analyse von 8 Hauptmünzen zu sehen (API-Aufruf)',
  ...
  es: {
    ...
    aiForecastClickMsg: 'Haz clic para ver el análisis IA de 8 monedas principales (llamada API)',
